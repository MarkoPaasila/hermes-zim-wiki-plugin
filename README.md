...
**Version:** `2026.06.14.2` — see [VERSIONING.md](VERSIONING.md) for the release scheme. Release history: [CHANGELOG.md](CHANGELOG.md).
...
| `zim_lookup_page` | Find pages by basename (OR terms, configurable threshold default 95) and return full bodies in one call |
